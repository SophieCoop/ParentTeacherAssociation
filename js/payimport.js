...
var PayImport = (function () {
  ...
  var KEYS = {
    ...
    /* בפייבוקס אפשר לצרף לגבייה שאלה למשלמים, ומנהלי ועד שואלים בה
       הרבה פעמים בשביל מי התשלום. הכותרת בקובץ היא נוסח השאלה עצמה,
       ולכן הרשימה כאן מכסה את הניסוחים שבהם *נשאל שם הילד/ה* בלבד.
       "שאלת מנהל" עצמה אינה ברשימה במתכוון: זו כותרת גנרית שמאחוריה
       יכולה לעמוד כל שאלה — בקובץ אמיתי היא החזיקה "תשלום ב3 תשלומים"
       — ולסמן אותה כעמודת שם הילד/ה פירושו להצהיר על עמודה שאינה
       כזאת, ואז אף שורה אינה מזוהה בלי שברור למה. מי שהשאלה שלו כן
       שואלת את השם יכול להצביע עליה ביד בבורר העמודות. */
