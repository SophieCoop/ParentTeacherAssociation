...
התבנית בנויה בטבלאות ובעיצוב בשורה (inline) — לא מתוך נוסטלגיה, אלא
...
- **Message body**: למחוק את התוכן הקיים ולהדביק את `confirm-signup.html`
  **במלואו**, מהשורה הראשונה ועד האחרונה.
