...
לשירות משלנו, כך שהם יגיעו מ-`hello@vaadhorim.com`.
...
**למה `hello@` ולא `noreply@`.** כתובת שאי אפשר להשיב לה מסמנת לשרתי
הדואר שההודעה חד־כיוונית, ויש מסננים שמתייחסים לכך כאות לדיוור המוני.
כתובת אמיתית שאפשר להשיב אליה נוטה לעבור טוב יותר, ומשתמש שעונה מקבל
בן אדם ולא קיר. שווה שהתיבה תהיה קיימת ותיקרא, אחרת היינו חוזרים
ל-`noreply` בשם אחר.
...
1. המייל הגיע, והשולח הוא `ועד הורים <hello@vaadhorim.com>`.
